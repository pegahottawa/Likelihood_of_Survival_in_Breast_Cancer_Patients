...
print "Final result recursive logistic discovery cleaned "
...
rfecv_model2 = logreg.fit(X_train_rfecv ,y_train)
y_pred2=logreg.predict(X_test_validation_rfecv)

print "Final result recursive logistic validation cleaned "

print(logreg.score(X_test_validation_rfecv, y_test_validation))
